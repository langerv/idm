...
### Todo
- Add a global blood variable increasing in time and evolve local behaviours (i.e AgentSpeak rules) to a predator model. Rabbits should extinct since they are limited, and humanimals should fight each other
